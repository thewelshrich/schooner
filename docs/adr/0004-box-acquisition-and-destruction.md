...
Allowing provider concerns to shape Repositories, Worktrees, and Sessions would
...
preparation, Repository, Worktree, and Session model. Provider adapters acquire
