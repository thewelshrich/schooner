...
func sameOperation(a, b ProvisionOperation) bool {
	return a.Name == b.Name && a.Profile == b.Profile && a.Region == b.Region && a.Size == b.Size && a.Image == b.Image && a.NetworkID == b.NetworkID && slices.Equal(a.AccessKeyIDs, b.AccessKeyIDs) && slices.Equal(a.LocalPublicKeys, b.LocalPublicKeys) && a.AutomaticBackups == b.AutomaticBackups && a.IPv6 == b.IPv6 && a.ProjectRoot == b.ProjectRoot
}
