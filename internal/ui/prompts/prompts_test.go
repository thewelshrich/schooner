...
func TestDigitalOceanProvisionSeparatesLocalAndAccountSSHKeys(t *testing.T) {
	...
	draft := ProvisionDraft{Name: "work", ProjectRoot: "~/schooner", Region: "fra1", Size: "small", Image: "ubuntu-24-04-x64", LocalPublicKeys: []provider.PublicKey{local}, AccessKeyIDs: []string{"9"}, IPv6: true}
